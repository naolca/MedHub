...
const get_medicines_filter_dto_1 = require("./dto/get-medicines-filter.dto");
let MedicinesController = class MedicinesController {
    constructor(medicinesService) {
        this.medicinesService = medicinesService;
    }
    getMedicines(filterDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [get_medicines_filter_dto_1.GetMedicinesFilterDto]),
